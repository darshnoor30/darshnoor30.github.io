...
- `styles.css` — responsive layout, accessible states, and visual system
- `script.js` — navigation, progressive reveal, and reduced-motion-aware canvas effect
- `Darshnoor_Kaur_Resume.pdf` — public résumé
